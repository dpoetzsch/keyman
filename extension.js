...
KeyMan.prototype =
{
	...
	_init: function() 
	{
		...
		this.menu.connect('open-state-changed', Lang.bind(this, function(menu, open)
		{
			...
			if (open) { this.searchEntry.grab_key_focus(); }
			else { this.searchEntry.get_stage().set_key_focus(null); }
		}));
	...
	{    		
		...
		let item = new PopupMenu.PopupMenuItem("FooBar");
		item.connect('activate', Lang.bind(this,function(){
			this.menu.close();
			St.Clipboard.get_default().set_text(St.ClipboardType.CLIPBOARD, "FooBar");
